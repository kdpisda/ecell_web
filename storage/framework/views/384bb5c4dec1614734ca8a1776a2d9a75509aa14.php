...
<div class="container">
    <center>
        <div class="row">
        <?php $__currentLoopData = $event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xs-12 col-sm-12 col-md-12 col-ls-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span>
                            <?php echo e($event_item->title); ?>

                        </h3>
                        <input type="hidden" name="event_id" value="<?php echo e($event_item->event_id); ?>">
                        <span class="glyphicon glyphicon-option-vertical" id="event_id"></span>
                    </div>
                    <div class="panel-body">
                        <?php if($event_item->meta == ''): ?>
                            <img src="/images/esummit_black.png" alt="E-Summit 17" class="img-rounded" height="300px">
                        <?php else: ?>
                            <img src="/uploads/events/<?php echo e($event_item->meta); ?>" alt="E-Summit 17" class="img-rounded" height="300px">
                        <?php endif; ?>
                        <blockquote>
                            <h3> <?php echo e($event_item->description); ?> </h3>
                        </blockquote>
                        <p> <?php echo e($event_item->details); ?> </p>
                    </div>
                    <div class="panel-footer">
                        <span class="glyphicon glyphicon-map-marker" area-hidden="true"></span>
                        <?php echo e($event_item->venue); ?>
