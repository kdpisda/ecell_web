                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="sponsor Title" name="title" id="edit_sponsor_title">
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                      <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="sponsor Description" name="description" id="edit_sponsor_description">
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <textarea placeholder="sponsor Details" class="form-control" rows="5" name="details" id="edit_sponsor_detail"></textarea>
                            </div>
                        </div>
                    </div><br> 
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="sponsor Venue" name="venue" id="edit_sponsor_venue">
                            </div>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="datetime" class="form-control" placeholder="sponsor Time" id="edit_sponsor_time">
                            </div>
                        </div>
                    </div><br>
                </div>
    ...
    function edit_sponsor(sponsor_id){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $("#edit_sponsor_title").val(data.sponsor_name);
                $("#edit_sponsor_description").val(data.sponsor_description);
                $("#edit_sponsor_detail").val(data.sponsor_detail);
                $("#edit_sponsor_venue").val(data.sponsor_venue);
                $("#edit_sponsor_time").val(data.sponsor_time);
                $("#edit_sponsor_meta").val(data.sponsor_pic);
