            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-ls-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <input type="hidden" name="sponsor_id" value="{{ $sponsor_item->sponsor_id }}">
                        <span class="glyphicon glyphicon-option-vertical" id="sponsor_id"></span>
                    </div>
                    <div class="panel-body">
                        @if($sponsor_item->meta == '')
                            <img src="/images/esummit_black.png" alt="E-Summit 17" class="img-rounded" height="300px">
                        @else
                            <img src="/uploads/sponsors/{{ $sponsor_item->meta }}" alt="E-Summit 17" class="img-rounded" height="300px">
                        @endif
                        <blockquote>
                            <h3> {{ $sponsor_item->description }} </h3>
                        </blockquote>
                        <p> {{ $sponsor_item->details }} </p>
                    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="gridSystemModalLabel">Add an sponsor</h4>
          </div>
          <div class="modal-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="input-group">
                        <span class="input-group-addon" id="sponsor_title">Title</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="input-group">
                        <span class="input-group-addon" id="sponsor_detail">Detail</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="input-group">
                        <span class="input-group-addon" id="sponsor_venue">Venue</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="input-group">
                        <span class="input-group-addon" id="sponsor_time">Time</span>
